...
export function getMoviesDetails(successCallBack,errorCallBack){
    return async function(dispatch){
        try{
            let responseGoW = await axiosNoAuth.get(`http://www.omdbapi.com/?i=tt3896198&apikey=dafa6536&t=Barfi!`);
            ...
            let responsebmb = await axiosNoAuth.get(`http://www.omdbapi.com/?i=tt3896198&apikey=dafa6536&t=Dev.D `);
